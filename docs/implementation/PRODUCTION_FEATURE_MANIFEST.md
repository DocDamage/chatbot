...
| `SPEC-026` | Capability Fusion Hub, evaluations, and promotion workflow | `/api/capabilities/*` | `CapabilityHubPanel`, `CapabilityPromotionView`, `RepositoryFindingsView` | CapabilityRegistry; evaluation, observability, persistence, and promotion services; CF-04 through CF-08 adapters | Local `.capabilities/` telemetry/decision files plus bounded job evidence | Developer | Local only; hosted registration denied until separate promotion and production certification | `LOCAL_ONLY_EXPERIMENTAL` | Complete local release and unchanged server/client coverage policies pass at `aec8871`; exact-final-head GitHub CI, independent review, external canaries, and human certification remain open | `docs/implementation/evidence/capability-fusion/CF-04-10/2026-08-25_aec8871/` | `P07-T05` plus applicable feature-specific Phase 7 tasks |
