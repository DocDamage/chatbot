...
| `CF-04-10-LOCAL-RELEASE` | `IMPLEMENTED_NOT_VERIFIED` | `aec8871623870623204bc93e90ebeb52dd51aea0` | `docs/implementation/evidence/capability-fusion/CF-04-10/2026-08-25_aec8871/` | Unchanged server and client coverage policies pass; release, browser, accessibility, packaging, inventory, reachability, environment, and docs gates pass locally. Exact-final-head GitHub Required CI, independent review, and external canaries remain open. |
